...
const regex_a7d = /^(MAJOR|PROGRAM|LICENSE)([\t]{0,2})([ ]{0,}[\d]{1,3}[-\d]{0,4}[ ]{0,2}[CREDITScredits ]*|[ ]{0,}[\d]{1,3}[-\d]{0,4}[ ]{0,2}[CREDITScreditsHOUhou ]*)[ \t]{0,3}$/gm;  // Looking specifically for the word : ^MAJOR or ^PROGRAM TAB and then some type of Number and Hours or Credits etc.
